...
class Predictor(predictor_base.Predictor):
  ...
  def __call__(self,
    ...
    def one_step_prediction(inputs, scan_variables):
      ...
      predictions, embeddings, latent = self._predictor(
      ...
      return next_inputs, (flat_pred, embeddings, latent)
    ...
    _, (flat_preds, embeddings, latent) = hk.scan(one_step_prediction, inputs, scan_variables)
    ...
    return predictions, embeddings, latent
